...
export default function Component() {
    ...
    return (
        // <Navbar fluid className='p-4 text-lg bg-black '>
        //     <Navbar.Brand as={Link} href="#">
        //         <img src="/mnl-logo.png" className="mr-3 h-4 sm:h-12" alt="MNL Logo" />
        //     </Navbar.Brand>
        //     <Navbar.Toggle />
        //     <Navbar.Collapse>
        //         <Navbar.Link href="/">Home</Navbar.Link>
        //         <Navbar.Link href="/cursos/strategyquantx">Curso de StrategyQuant X</Navbar.Link>
        //         <Navbar.Link href="/cursos/avanzado">Avanzado</Navbar.Link>
